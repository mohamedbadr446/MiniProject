        ...
        stage('Update XRay') {
           steps {
               script{
                       ...
                       bat "curl -H 'Content-Type: /target/surefire-reports/testng-results.xml' -H 'Authorization: Bearer ${JIRA_XRAY_TOKEN}' -X PUT  --data '@xray-infos.json' https://team-1612820401992.atlassian.net/jira/software/projects/BACBPI/boards/48/backlog/${TEST_EXEC_KEY}"               }
          }
       }
